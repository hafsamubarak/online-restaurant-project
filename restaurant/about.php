		...
		<main>
			<header class="row tm-welcome-section">
				...
				<p class="col-12 text-center">This is about page of simple house template.
					You can modify and use this HTML template for your website. Total 3 HTML pages included in this
					template. Header image has a parallax effect.</p>
			</header>
				...
				<div class="row">
					<article class="col-lg-6">
						<figure class="tm-person">
							<img src="img/1.jpg" alt="Image" class="img-fluid tm-person-img"
								style="width: 37%; height: 50vh;" />
							<figcaption class="tm-person-description">
								<h4 class="tm-person-name">Hafsa Ahmed</h4>
					...
					<article class="col-lg-6">
						<figure class="tm-person">
							<img src="img/4.jpg" alt="Image" class="img-fluid tm-person-img"
								style="width: 37%; height: 50vh;" />
							<figcaption class="tm-person-description">
								<h4 class="tm-person-name">Safei-Eldin Mustafa</h4>
						...
						<figure class="tm-person">
							...
							<figcaption class="tm-person-description">
								...
								<div>
									...
									<a href="https://instagram.com" class="tm-social-link"><i
											class="fab fa-instagram tm-social-icon"></i></a>
									<a href="https://youtube.com" class="tm-social-link"><i
											class="fab fa-youtube tm-social-icon"></i></a>
								</div>
							</figcaption>
						</figure>
					</article>-->
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="tm-feature">
							...
							<p class="tm-feature-description">Donec sed orci fermentum, convallis lacus id, tempus elit.
								Sed eu neque accumsan, porttitor arcu a, interdum est. Donec in risus eu ante.</p>
					...
					<div class="col-lg-4">
						<div class="tm-feature">
							...
							<p class="tm-feature-description">Maecenas pretium rutrum molestie. Duis dignissim egestas
								turpis sit. Nam sed suscipit odio. Morbi in dolor finibus, consequat nisl eget.</p>
					...
					<div class="col-lg-4">
						<div class="tm-feature">
							...
							<p class="tm-feature-description">Morbi in dolor finibus, consequat nisl eget, pretium nunc.
								Maecenas pretium rutrum molestie. Duis dignissim egestas turpis sit.</p>
