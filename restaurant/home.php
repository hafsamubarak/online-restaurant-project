	...
	<div class="container">
		...
		<main>
			<header class="row tm-welcome-section">
				...
				<h2 class="col-12 text-center tm-section-title">Welcome <?php echo $_SESSION['name'];?></h2>
				<?php
			    }else{
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							...
							<figcaption>
								...
								<button type="submit" class="tm-btn tm-btn-success tm-btn-right" style="margin-top:-97px;">
								Order
								</button>
								</div>
							</figcaption>
